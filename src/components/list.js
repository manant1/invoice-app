...
const List = ({ items, className }) => {
  return (
    <div className={className}>
      {items.map((item, i) => (
        <div key={`invoice-list-item-${i}`} className="invoice-mobile-grid md:invoice-grid rounded-xl bg-white w-full py-4 px-3 mt-7 mb-7">
          ...
          <div className="hidden md:block chevron">
